...
<div class="period-list">
    ...
    <h1><?= Html::encode($this->title.' Puskesmas') ?></h1>
    ...
    <div class="form-group">
                ...
                [
                    ...
                    'onchange'=>'
                        $.pjax.reload({
                            url: "'.Url::toRoute(['period/list']).'?period="+$(this).val(),
                ...
                ButtonDropdown::widget([
                    ...
                    'dropdown' => [
                        'items' => [
                            ['label' => \Yii::t('yii', 'POA - Komponen per Rekening'),
                                // 'linkOptions' => [
                                //     'data' => [
                                //         'method' => 'POST',
                                //         // 'confirm' => \Yii::t('yii', 'Are you sure you want to delete this item?'),
                            ...
                            ['label' => \Yii::t('yii', 'POA - Komponen per Puskesmas'),
                                'url' => Url::to(['rekap-pkm', 'id' => 'k']),
                                'visible' => true,   // same as above
                            ],
                            ['label' => \Yii::t('yii', 'POA - Detail per Komponen Semua Puskesmas'),
                                'url' => Url::to(['rekap-pkm-detail', 'cond' => 'def']),
                                'visible' => true,   // same as above
                            ],

                            ['label' => \Yii::t('yii', 'Realisasi - UKM Esensial'),
                                'url' => Url::to(['laporan-ukm-all', 'id' => '0', 'mo' => '1']),
                                'visible' => false,   // same as above
                            ],
                            ['label' => \Yii::t('yii', 'Realisasi - Covid-19'),
                                'url' => Url::to(['laporan-ukm-all', 'id' => '1', 'mo' => '1']),
                                'visible' => false,   // same as above
                            ],
                            ['label' => \Yii::t('yii', 'POA - Per Sub Kegiatan'),
                                'url' => Url::to(['sub-kegiatan', 'id' => '0']),
                                'visible' => true,   // same as above
                            ],
                            ['label' => \Yii::t('yii', 'SP2D - Rekap Per Puskesmas'),
                                'url' => Url::to(['rekap-sp2d', 'id' => '21']),
                                'visible' => true,   // same as above
                            ],
                            ['label' => \Yii::t('yii', 'Realisasi - Rekap Per Upaya'),
                                'url' => Url::to(['rekap-real', 'id' => '1']),
                                'visible' => true,   // same as above
                            ],
                        ],
                    ],
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            ['class' => 'yii\grid\ActionColumn',
                ...
                'template' => $template,
                'buttons' => [
                    'poa' => function ($url, $model, $session) {
                        $session = Yii::$app->session;
                            ...
                            'dropdown' => [
                                'items' => [
                                    ...
                                    ['label' => \Yii::t('yii', 'SP2D'),
                                        ...
                                        'url' => Url::to(['sp2d/index', 'unit' => $model['unit_id'], 'tahun' => $session['periodValue']]),
                                        'visible' => true,   // same as above
                                    ],
                                    ...
                                    ['label' => \Yii::t('yii', 'Lihat Data'),
                                        ...
                                        'url' => Url::to(['period/datapoaadm', 'id' => $model['unit_id'], 'p' => 'def']),
                                        'visible' => true,   // same as above
                                    ],

                                    ['label' => \Yii::t('yii', 'Realisasi Kinerja'),
                                        'url' => Url::to(['period/realperform', 'id' => $model['unit_id'], 'tw' => '1']),
                                        'visible' => true,   // same as above
                                    ],
                                ],
                            ],
            ...
            //             ],
            //             'options' => ['class' => $model['status_bar_ubah'], 'style' => 'width: 100%']
            //         ]);
            //     },
            // ],
            ...
            [
                ...
                'content' => function($model) {
                    return Progress::widget([         
                        'bars' => [
                            ['percent' => $model['prosentase'], 'label' => $model['persen_real'].'%', 'options' => ['class' => $model['bar_color_real']]],
                        ],
                        'options' => ['class' => $model['status_bar_real'], 'style' => 'width: 75%']
                    ]);
                },
            ],
                            ...
                            'dropdown' => [
                                'items' => [
                                    ...
                                    ['label' => \Yii::t('yii', 'Lihat Data'),
                                        ...
                                        'url' => Url::to(['detailpoaadm', 'p' => 1, 'unit_id' => $model['unit_id']]),
                                        'visible' => true,   // same as above
                                    ],
                                ],
                            ],
                            ...
                            'dropdown' => [
                                'items' => [
                                    ...
                                    ['label' => \Yii::t('yii', 'Lihat Data'),
                                        ...
                                        'url' => Url::to(['detailpoaadm', 'p' => 2, 'unit_id' => $model['unit_id']]),
                                        'visible' => true,   // same as above
                                    ],
                                ],
                            ],
                            ...
                            'dropdown' => [
                                'items' => [
                                    ...
                                    ['label' => \Yii::t('yii', 'Lihat Data'),
                                        ...
                                        'url' => Url::to(['detailpoaadm', 'p' => 3, 'unit_id' => $model['unit_id']]),
                                        'visible' => true,   // same as above
                                    ],
                                ],
                            ],
                            ...
                            'dropdown' => [
                                'items' => [
                                    ...
                                    ['label' => \Yii::t('yii', 'Lihat Data'),
                                        ...
                                        'url' => Url::to(['detailpoaadm', 'p' => 4, 'unit_id' => $model['unit_id']]),
                                        'visible' => true,   // same as above
                                    ],
                                ],
                            ],
                            ...
                            'dropdown' => [
                                'items' => [
                                    ...
                                    ['label' => \Yii::t('yii', 'UKM ESENSIAL'),
                                        ...
                                        'url' => Url::to(['ukm/laporan-ukm-all', 'id' => '0', 'unit_id' => $model['unit_id'], 'mo' => '1']),
                                        'visible' => true,   // same as above
                                    ],
