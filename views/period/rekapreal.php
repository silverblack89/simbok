...
<p>
    ...
    [
        ...
        'onchange'=>'
            $.pjax.reload({
                url: "'.Url::toRoute(['period/rekap-real']).'?id="+$(this).val(),
    ...
    <?= Html::a('<span class="glyphicon glyphicon-export"></span> Export', ['export-rekap-real'], ['title' => 'Export Excel', 'class' => 'btn btn-default']) ?>
</p>
