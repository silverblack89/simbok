...
<?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'pageSummaryOptions' => ['colspan' => '28', 'append' => 'Total', 'style' => 'text-align:right'],
                'groupFooter' => function ($model, $key, $index, $widget) { // Closure method
                    return [
                        'mergeColumns' => [[0,27]], // columns to merge in summary
                        'content' => [             // content to show in each summary cell
                            1 => 'Jumlah',
                            28 => GridView::F_SUM,
                        ],
                        'contentFormats' => [      // content reformatting for each summary cell
                            28 => ['format' => 'number', 'decimals' => 0, 'decPoint'=>',', 'thousandSep'=>'.'],
                        ],
                        'contentOptions' => [      // content html attributes for each summary cell
                            1 => ['style' => 'text-align:right'],
                            28 => ['style' => 'font-size:11px; text-align:right'],
                        ],
