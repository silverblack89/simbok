...
<div class="realization-form">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <?php $form = ActiveForm::begin(['id' => 'realization-form', 'options' => ['autocomplete' => 'off']]); ?>
...
<?php
$js=<<< JS
    $('#realization-form').on('beforeSubmit', function (e) {

        var sp2d = parseInt(document.getElementById("realization-sp2d").value);
        var prev_real = parseInt(document.getElementById("realization-realisasi_lalu").value);
        var real = parseInt(document.getElementById("realization-total_realisasi").value);
        var jml_poa =  parseInt(document.getElementById("realization-jml_poa").value);
        var jumlah = parseInt(document.getElementById("realization-jumlah").value.replaceAll(".","")) || 0;
        var form = $(this);
