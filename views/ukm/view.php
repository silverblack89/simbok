...
$this->title = 'Laporan BOK COVID Bulan '.$bulan;
...
<div class="ukm-view">
    <div class="row">
        <div class="col-sm-2 pull-right">
            <?= Html::a('<span class="glyphicon glyphicon-export"></span> Export Excel', ['export-realisasi', 'bln' => $bln], ['class' => 'btn btn-success pull-right', 'target' => '_blank']) ?>
        </div>
    </div>
    ...
    <table id="tabel1" class="table table-bordered">
        <thead>
            <tr>
                ...
                <th style="text-align:center;border:1px solid grey">Jml Kontak erat yg dilacak (Bulan ini)</th>
                <th style="text-align:center;border:1px solid grey">Jml orang Terkonfirmasi yg di pantau (bulan ini)</th>
                <th style="text-align:center;border:1px solid grey">Tenaga Tracer (Kondisi sampai bulan ini)</th>
                <th style="text-align:center;border:1px solid grey">Tenaga surveilans/Pengolah data (Kondisi sampai bulan ini)</th>
            </tr>
        </thead>
        <tbody>
            <?php 
                ...
                <tr>
                    ...
                    <td style="text-align:right;border:1px solid grey;">
                        <H5><?php echo Yii::$app->runAction('ukm/get-real', ['no' => $datareal['no'], 'bulan' => $model->bulan, 'pagu' => $datareal['jumlah']]); ?></H5>
                    </td>
                    ...
                    <td style="text-align:right;border:1px solid grey;">
                        <H5><?php echo $datareal['jml_ke']; ?></H5>
                    </td>

                    <td style="text-align:right;border:1px solid grey;">
                        <H5><?php echo $datareal['jml_confirm']; ?></H5>
                    </td>

                    <td style="text-align:right;border:1px solid grey;">
                        <H5><?php echo $datareal['tenaga_tracer']; ?></H5>
                    </td>

                    <td style="text-align:right;border:1px solid grey;">
                        <H5><?php echo $datareal['tenaga_surveilans']; ?></H5>
                    </td>
                </tr>
            <?php 
                $no = $no+1;
