...
$this->params['breadcrumbs'][] = ['label' => 'Data Puskesmas '.$puskesmas, 'url' => ['period/list', 'period' => $session['periodValue']]];
        ...
        <div class="col-sm-4">
            <?php if ($session['id'] == '0') {?>
                ...
                [
                    ...
                    'onchange'=>'
                        $.pjax.reload({
                            url: "'.Url::to(['ukm/laporan-ukm-all', 'unit_id' => $session['unitId'], 'id' => $session['id']]).'&mo="+$(this).val(),
        ...
        <tbody>
            <?php 
                ...
                foreach($data as $datareal){ 
                    $real = Yii::$app->runAction('ukm/get-real-ukm', ['id' => $mo, 'no' => $datareal['no'], 'pagu' => $datareal['jumlah']]);   
                ?>
                <tr>
